...
var aboutComponent = (function (_super) {
    ...
    function aboutComponent() {
        ...
        _this.auth = function () { return !!firebase_auth_1.user; };
        _this.state = {
            content: 'about'
        };
        _this.view = function (state) {
            return apprun_1.default.createElement("div", null,
                apprun_1.default.createElement("h1", null,
                    state.content,
                    " - ",
                    state.authorized ? firebase_auth_1.user.displayName : '[anonymous]',
                    " "));
        };
        _this.update = {
            '#about': function (state) { return (__assign({}, state, { authorized: _this.auth() })); },
        };
        return _this;
    }
